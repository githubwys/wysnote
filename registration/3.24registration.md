...
也可以用于求解相机内参矩阵A，这时再通过11个参数，再求解出A阵即可。
...
<img src="3.24registration.assets/20190412195117945.png" alt="img" style="zoom: 67%;" />

<img src="3.24registration.assets/20190412195329745.png" alt="img" style="zoom: 33%;" />
...
利用<img src="3.24registration.assets/20190412200120888.png" alt="img" style="zoom: 80%;" />，中r1，r2正交，模均为1的性质，求解h1，h2.

剩余A阵中5个参数，通过3个单应性矩阵可以求解

<img src="3.24registration.assets/20190412202442196.png" alt="img" style="zoom: 50%;" />
...
![image-20210330115540093](/home/tonglu/snap/typora/33/.config/Typora/typora-user-images/image-20210330115540093.png)
...
1、无畸变求解内参；再计算畸变系数，利用畸变系数得到新的像点坐标
